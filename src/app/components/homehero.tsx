...
const movies: Movie[] = [
  ...
  },
  {
    ...
    background:
      "https://www.ndtv.com/photos/entertainment/stills-inception-7704",
  },
  {
    id: 3,
    title: "Dune",
    ...
    background:
      "https://www.vanityfair.com/hollywood/2020/04/behold-dune-an-exclusive-look-at-timothee-chalamet-zendaya-oscar-isaac-and-more",
  },
  {
    id: 4,
    title: "The Batman",
    ...
    background:
      "https://www.mpeppler.com/shop/the-batman-alternative-movie-poster",
  },
];
  ...
  return (
    <section className="relative w-full px-5 py-16 flex flex-col items-center overflow-hidden">
      ...
      <div
        ...
        className="relative z-10 flex overflow-x-auto snap-x snap-mandatory w-full scrollbar-hide scroll-smooth"
      >
        {movies.map((movie, index) => (
          ...
          >
            <div className="flex gap-6 items-center bg-white/10 backdrop-blur-lg rounded-2xl shadow-lg overflow-hidden cursor-pointer max-w-3xl w-full">
              <Image
                src={movie.poster}
                alt={movie.title}
                width={120}
