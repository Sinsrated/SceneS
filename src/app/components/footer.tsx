...
export default function Footer() {
  return (
    <motion.footer
      ...
      className="mt-12 backdrop-blur-xl bg-white/10 border-t border-white/20 text-white"
    >
      <div className="max-w-7xl mx-auto px-6 py-10 flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="flex gap-4">
          <a href="#" className="p-2 rounded-full bg-white/10 hover:bg-cyan-500/30 transition">
            <Facebook size={18} />
          </a>
          <a href="#" className="p-2 rounded-full bg-white/10 hover:bg-cyan-500/30 transition">
            <Twitter size={18} />
