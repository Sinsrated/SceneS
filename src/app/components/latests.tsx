...
import { Play, SkipForward, Download, ChevronLeft, ChevronRight, PlayIcon, PlaySquareIcon, PlayCircleIcon } from "lucide-react";
...
const timeout = setTimeout(() => setShowSkipButton(false), 2000);
  ...
  onMouseLeave={() => setHovering(false)}>
      <h2 className="text-2xl font-bold text-gray-400 mb-6">Latest TV Shows</h2>
...
<div className="flex flex-col md:flex-row gap-8 max-w-1xl mx-auto">
 ...
 <div className="relative w-[100px] h-[60px] flex-shrink-0">
  ...
  {ep.video_url && (
    ...
    >
      <PlayCircleIcon size={20} className="text-cyan-400 hover:text-cyan-300 transition-colors duration-200" />
    </button>
  )}
</div>
